...
from drawings.drawing import draw_from_dotted_set, draw_hit_blocks, draw_ships, show_message_at_rect_center
from drawings.grid import Grid
...
def play(
    *,
    computer_turn: bool,
    human_ships_to_draw: list,
    human_ships_set: set,
    human_ships_working: list,
    game_over: bool,
):
...
# def finish_the_game(*, game_over: bool) -> bool:
...
#             pygame.quit()
#             sys.exit()
#         if event.type == pygame.MOUSEBUTTONDOWN and play_again_button.rect.collidepoint(mouse):
#             main()
#         if event.type == pygame.MOUSEBUTTONDOWN and quit_game_button.rect.collidepoint(mouse):
#             pygame.quit()
#             sys.exit()
#     pygame.display.update()
#     return game_over
...
def draw_grids_and_manual_ships(
    *,
    drawing: bool,
    human_ships_to_draw: list,
    human_ships_working: list,
    ...
    global start, ship_size
    mouse = pygame.mouse.get_pos()
    x_start, y_start = mouse
    ...
    return ships_not_created, drawing, human_ships_to_draw, human_ships_working


def draw_grids_and_auto_ships(
    *,
    ships_not_created: bool,
    ships_creation_not_decided: bool,
    game_over: bool,
    human_ships_to_draw: list,
    human_ships_working: list,
    human_ships_set: set,
